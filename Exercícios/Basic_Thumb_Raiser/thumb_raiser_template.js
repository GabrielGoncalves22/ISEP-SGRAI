    ...
    update() {
        if (!this.gameRunning) {
            if (this.maze.loaded && this.player.loaded) { // If all resources have been loaded
                ...
                ...; */
                this.scene3D.add(this.lights.object, this.player.object);
            ...
            if (!this.animations.actionInProgress) {
                ...
                if (this.maze.foundExit(this.player.position)) {
                    ...
                    */
                    ...
                    if (this.player.keyStates.backward) { // The player is moving 
                        let x = -coveredDistance * Math.sin(direction);
                        let z = -coveredDistance * Math.cos(direction);
                        const newPosition = new THREE.Vector3(x, this.player.position, z).add(this.player.position);
                        ...
                        */
                        ...
                        else if (this.keyChange.thumbsUp) {
