...
export default class Lights {
    constructor(parameters) {
        ...
        */
        ...
        this.object.pointLight1.set(this.pointLight1.position.x, this.pointLight1.position.y, this.pointLight1.position.z);
        ...
        */
        ...
        this.object.pointLight2.set(this.pointLight2.position.x, this.pointLight2.position.y, this.pointLight2.position.z);
