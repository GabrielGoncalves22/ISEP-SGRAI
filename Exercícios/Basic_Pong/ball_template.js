    ...
    update(deltaT) {
        ...
        */
        ...
        if (centerIncrement.x < 0) { // The ball is moving to the left
            if (this.center.y >= this.player1.center.y - this.player1.halfSize.y &&
                ...
                this.player2.center.x - this.player1.halfSize.x >= this.center.x + this.radius
        ...
        */
            ...
            if (this.center.y >= this.player2.center.y - this.player2.halfSize.y &&
                this.center.y <= this.player2.center.y + this.player2.halfSize.y &&
